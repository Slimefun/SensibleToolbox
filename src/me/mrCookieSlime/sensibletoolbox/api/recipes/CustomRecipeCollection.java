...
public class CustomRecipeCollection {
     ...
     *
     * @param recipe the custom recipe to add
     * @param allowWild if true, add another recipe with the ingredients
     ...
     *
     * @param shaped if true, use a shaped recipe
     * @param input list of input ingredients
